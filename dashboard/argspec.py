...
GROUPS = {
    ...
    "optimization": ["--attn-backend", "--attn-impl", "--attn-precision",
...
FALLBACK: List[Dict[str, Any]] = [
    ...
    {"flag": "--attn-precision", "dest": "attn_precision", "kind": "choice",
     "choices": ["auto", "fp32", "tf32", "fp16", "bf16"], "default": None,
     "help": "", "group": "optimization"},
